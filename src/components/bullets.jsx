...
function Bullets() {
    return (
        <section className="bg-bullet p-5 flex flex-col md:flex-row justify-between items-center gap-4 my-10 min-h-screen max-h-full">
            <Image
                src="/guia.png"
            ...
            <article className="flex justify-between items-center gap-3 w-full  md:w-6/12 flex-wrap">
                <h2 className="w-full text-2xl text-center py-5">No tengas miedo a aprender</h2>
                <p className="p-6 md:p-3 bg-[#191919] rounded-xl shadow text-xl flex flex-col items-center justify-centergap-3 w-full  md:w-[45%]  md:py-4">
